...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate, depth, reduction, n_classes, bottleneck):
        ...
        self.out_features = 456

        self.global_avgpool = nn.AdaptiveAvgPool2d(1)

        self.bn1 = nn.BatchNorm2d(n_channels)
        # self.fc = nn.Linear(456, n_classes)
    ...
    def forward(self, x, aug=None, cl_aug=None):
        ...
        out = self.global_avgpool(F.relu(self.bn1(out)))
...
def densenet(pretrained=True, growth_rate=12, depth=40, num_classes=7, cfg=None, args=None):
