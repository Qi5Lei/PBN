...
_C.DATALOADER.TRAIN_X.CLIP_BATCH_SIZE = 32
...
# for norm
_C.NORM = CN()
_C.NORM.REPLACE_NORM = False
_C.NORM.REPLACE_NORM_NAME = None
_C.NORM.ORIGIN_NORM = 'FrozenBN'
_C.NORM.UPDATE_NORM = 'BN'
_C.NORM.NORM_TYPE = None
_C.NORM.NUM_NORM = 1
_C.NORM.FREEZE_AT = 2
_C.NORM.APPLY_LAYER = ''
_C.NORM.POINT_GROUP = 1
_C.NORM.STOCH_NORM_ALPHA = 0.5
_C.NORM.BLOCK_BN_IDX = '0,1,2'
_C.NORM.SHALLOW_APPLY_LAYER = False
_C.NORM.SHALLOW_NAME = None